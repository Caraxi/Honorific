...
public static unsafe class RainbowColour {
    public record RainbowStyle(string Name, byte[,] Colours, int AnimationStyle) {
        public RainbowStyle(string name, string b64, int animStyle) : this(name, Decode(b64), animStyle) { }
    ...
    public static RGB GetColourRGB(RainbowStyle style, int chrIndex, int throttle, bool animate = true) {
        ...
        var i = (animationOffset/ throttle + (chrIndex * style.AnimationStyle)) % rainbowColors.GetLength(0);
    ...
    public static RainbowStyle? GetStyle(int i) {
